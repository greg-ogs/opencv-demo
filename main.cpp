...
//! [normalize]
    ...
    Mat resizedI, resizedMagI;
    resize(I, resizedI, Size(600, 600), 0, 0, INTER_LINEAR); // Resize the input image to 600x600
    resize(magI, resizedMagI, Size(600, 600), 0, 0, INTER_LINEAR); // Resize the magnitude image to 600x600

    imshow("Input Image", resizedI);    // Show the resized input image
    imshow("spectrum magnitude", resizedMagI); // Show the resized magnitude image
